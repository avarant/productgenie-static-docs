...
2.  **Integration:** Learn how to embed the Product Genie widget on your website using our [Integration Guide](./guides/integration-guide/).
3.  **Explore the API:** Use the sidebar navigation to explore the different API categories:
